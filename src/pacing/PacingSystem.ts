 ...
 * challenges. Short pressure windows prevent multiple full challenge combinations from chaining
 * before the next recovery window. More than half of every cycle is deliberate breathing room.
 */
