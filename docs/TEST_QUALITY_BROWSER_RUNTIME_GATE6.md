...
6. A live container resize from 640x360 to 360x640 is observed by the render-resolution `ResizeObserver`, updates the canvas metadata and reconciles Foundation to portrait.
7. A second live resize to 800x450 reconciles back to landscape without losing the active Foundation scene.
